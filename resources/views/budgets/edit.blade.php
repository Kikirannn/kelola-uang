...
@section('content')
    <div class="mb-4">
        ...
        <h2 class="fw-bold">Edit Budget</h2>
    </div>
            ...
            <div class="card stats-card">
                <div class="card-body">
                    <form action="{{ route('budgets.update', $budget) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="category_id" class="form-label">Kategori Pengeluaran <span
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="amount" id="amount"
                                    ...
                                    value="{{ old('amount', $budget->amount) }}" step="0.01" min="0.01" required>
                            </div>
                            @error('amount')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="period" id="period" class="form-select @error('period') is-invalid @enderror"
                                required>
                                <option value="">Pilih Periode</option>
                                <option value="monthly" {{ old('period', $budget->period) == 'monthly' ? 'selected' : '' }}>
                                    Bulanan</option>
                                <option value="yearly" {{ old('period', $budget->period) == 'yearly' ? 'selected' : '' }}>
                                    Tahunan</option>
                            </select>
                            @error('period')
                                <div class="invalid-feedback">{{ $message }}</div>
